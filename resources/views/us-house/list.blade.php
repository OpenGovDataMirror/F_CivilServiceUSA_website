            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb component-breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemscope itemtype="http://schema.org/Thing" itemprop="item" href="/us-house/list/{{ $filter }}" {!! trackData('Nav', 'Breadcrumb', 'U.S. House ' . titleCase($filter)) !!}>
        ...
        <div class="container-fluid text-center">
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <h3>{{ str_replace('Representatives', '', titleCase($filter)) }} Representatives</h3>
                    <p>There are 435 Representatives, who sit in congressional districts which are allocated to each of the 50 U.S states. This is a list of <strong>{{ count($representatives) }} {{ str_replace('Representatives', '', titleCase($filter)) }} Representatives</strong> of the United States House of Representatives (117th United States Congress).</p>
                </div>
            </div>
            <div class="row">
